...
import static guru.sfg.beer.order.service.config.JmsConfig.DEALLOCATE_ORDER_QUEUE;
    ...
    public void execute(StateContext<BeerOrderStatusEnum, BeerOrderEventEnum> stateContext) {
        ...
        jmsTemplate.convertAndSend(DEALLOCATE_ORDER_QUEUE,
                DeallocateOrderRequest.builder()
                        ...
                        .build());
        log.debug(String.format("Send order deallocation request for order %s", beerOrderId));
    }
